...
The `backend/.env` file is intentionally committed to this repo. Normally you would never push credentials to git, but we've included it here so the professor can run the project and connect to our Supabase database without any extra setup.
